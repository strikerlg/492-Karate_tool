$(document).ready(function() { 
    $('#addseason').click(function() {
        ...
        $.post('php/updateaaukumite.php', 'first=' + IDfirst, function() { 
                      });   
        $.post('php/updateaaukumite.php', 'second=' + IDsecond,  function() { 
                      });
        $.post('php/updateaaukumite.php', 'third=' + IDthird,  function() { 
                      });
        $.post('php/updateaaukumite.php', 'fourth=' + IDfourth,  function(response) { 
            alert(response);
                      });
    });
});