$(document).ready(function() { 
    $('#addseason').click(function() {
        ...
        $.post('php/updateaaukata.php', 'first=' + IDfirst, function() { 
                      });   
        $.post('php/updateaaukata.php', 'second=' + IDsecond,  function() { 
                      });
        $.post('php/updateaaukata.php', 'third=' + IDthird,  function() { 
                      });
        $.post('php/updateaaukata.php', 'fourth=' + IDfourth,  function(response) { 
            alert(response);
                      });
    });
});