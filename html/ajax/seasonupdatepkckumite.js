$(document).ready(function() { 
    $('#addseason').click(function() {
        ...
        $.post('php/updatepkckumite.php', 'first=' + IDfirst, function() { 
                      });   
        $.post('php/updatepkckumite.php', 'second=' + IDsecond,  function() { 
                      });
        $.post('php/updatepkckumite.php', 'third=' + IDthird,  function() { 
                      });
        $.post('php/updatepkckumite.php', 'fourth=' + IDfourth,  function(response) { 
            alert(response);
                      });
    });
});