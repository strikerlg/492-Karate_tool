$(document).ready(function() { 
    $('#addseason').click(function() {
        ...
        $.post('php/updatepkckata.php', 'first=' + IDfirst, function() { 
                      });   
        $.post('php/updatepkckata.php', 'second=' + IDsecond,  function() { 
                      });
        $.post('php/updatepkckata.php', 'third=' + IDthird,  function() { 
                      });
        $.post('php/updatepkckata.php', 'fourth=' + IDfourth,  function(response) { 
            alert(response);
                      });
    });
});