...
function loserbox(){
    ...
    var average = "<fieldset><legend>Second Fight</legend><output id='fighter3'></output><input type='number' id='score3'><br><output id='fighter4'></output><input type='number' id='score4'><button onclick='fight()'>Score</button></fieldset>";
